...
//  Serial.print(theta);
  ...
  //float k[4] =  {-7.330547 , -0.756507 , -0.010000,  -0.012274};
  if(theta<0.05 and theta>-0.05 and count<30)
  {     
    k[0] = 6.7720319 ; k[1] = 0.6881601  ; k[3] =  -0.0  ; k[4] = 0.0107096;
    count++;
  }
//  else if(theta<0.05 and theta>-0.05 and count=>25)
//  {
//    count = 30;
//   }
   else if(theta>0.05 or theta<-0.05)
   {
      count = 0;
    }
